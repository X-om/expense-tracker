    ...
    return (
        <div>
            ...
            <Drawer isOpen={isOpen} backdrop="blur" size="xs" placement="left" onOpenChange={onOpenChange}>
                <DrawerContent className=" bg-darkBg text-zinc-300">
                    {
                        (onclose)=>(
                            <div>
                                ...
                                <DrawerBody>
                                    <div className="flex flex-col gap-4 py-4 px-2">
                                        <div className="border-b-1 border-zinc-300  pb-2">
                                            <Button className="text-zinc-300 justify-start py-2 text-lg w-full bg-darkBg hover:bg-dark-800" size="sm">option A</Button>
                                        </div>
                                        <div className="border-b-1 border-zinc-300 pb-2">
                                            <Button className="text-zinc-300 justify-start py-2 text-lg w-full bg-darkBg hover:bg-dark-800" size="sm">option A</Button>
                                        </div>
